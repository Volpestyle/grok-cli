...
describe('checkNextSpeaker', () => {
  ...
  it('should return null if grokClient.generateJson throws an error', async () => {
  ...
  it('should return null if grokClient.generateJson returns invalid JSON (missing next_speaker)', async () => {
    (chatInstance.getHistory as Mock).mockReturnValue([
      { role: 'model', parts: [{ text: 'Some model output.' }] },
    ] as Content[]);
  ...
  it('should return null if grokClient.generateJson returns a non-string next_speaker', async () => {
    (chatInstance.getHistory as Mock).mockReturnValue([
      { role: 'model', parts: [{ text: 'Some model output.' }] },
    ] as Content[]);
    (mockGrokClient.generateJson as Mock).mockResolvedValue({
  ...
  it('should return null if grokClient.generateJson returns an invalid next_speaker string value', async () => {
    (chatInstance.getHistory as Mock).mockReturnValue([
      { role: 'model', parts: [{ text: 'Some model output.' }] },
    ] as Content[]);
    (mockGrokClient.generateJson as Mock).mockResolvedValue({
